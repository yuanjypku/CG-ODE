...
if __name__=='__main__':
    ...
    # Model Setup
    # Create the model
    model = create_LSTM_model(args,input_dim,device)
    ...
    def train_single_batch(model,batch_dict_encoder,batch_dict_decoder,kl_coef=None):
        ...
        # train_res, loss
        return loss_value,train_res["MAPE"],train_res['MSE'],train_res["likelihood"],train_res["kl_first_p"],train_res["std_first_p"], 0,0
    ...
    def train_epoch(epo):
        ...
        for itr in tqdm(range(train_batch)):
            ...
            loss, MAPE,MSE,likelihood,kl_first_p,std_first_p,forward_nfe,backward_nfe = train_single_batch(model,batch_dict_encoder,batch_dict_decoder)
